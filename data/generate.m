...
ttl = 'inf';
maxNodes = 'inf';
prefix = strcat(dir, 'kr-online-', ttl, '-', maxNodes, '-');

% perfMatrix1 = csvread(strcat(prefix,'1.csv'),1,0);
% perfMatrix2 = csvread(strcat(prefix,'2.csv'),1,0);
% perfMatrix3 = csvread(strcat(prefix,'3.csv'),1,0);
% perfMatrix4 = csvread(strcat(prefix,'4.csv'),1,0);
% perfMatrix5 = csvread(strcat(prefix,'5.csv'),1,0);
% perfMatrix6 = csvread(strcat(prefix,'6.csv'),1,0);
% perfMatrix7 = csvread(strcat(prefix,'7.csv'),1,0);
% perfMatrix8 = csvread(strcat(prefix,'8.csv'),1,0);
% perfMatrix9 = csvread(strcat(prefix,'9.csv'),1,0);
% perfMatrix10 = csvread(strcat(prefix,'10.csv'),1,0);
